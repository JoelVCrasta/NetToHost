        ...
        <Card className="bg-slate-900/80 border-slate-800 backdrop-blur-xl shadow-2xl">
          <CardContent className="pt-6">
            ...
            {signUpMutation.isSuccess && (
              <div className="mb-6 p-3.5 rounded-xl border border-emerald-500/30 bg-emerald-950/30 text-emerald-300 text-sm flex items-start space-x-3">
            ...
            >
              ...
              <form.Field
                ...
                validators={{
                  onChange: ({ value }) => {
                    const result =
                      signUpSchema.shape.display_name.safeParse(value)
